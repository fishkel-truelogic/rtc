...
<div style="background-color:#000; margin-top:-50px; height:100%">
    <div id="main">
      <div id="site_content" style="margin-left: 22px; margin-right: 22px; margin-top: 22px; position: absolute; width: 515px;">
        <div id="content">
	        <form action="/admin-web/admin/sports" id="sport" onsubmit="return validateSport();" method="post" style="width: 75%;">
	            <div class="form_settings" style="color:#FFF">
	              <p><span style="width: 140px;">Deporte</span><input type="text" id="name" name="name" value="" /></p>
