...
<link rel="StyleSheet" href="/admin-web/css/style-login.css" type="text/css">
...
<body>
	<img src="/admin-web/images/back.jpg" style="position:absolute; top:0px; width:100%; height:100%">
		<div class="containerLogin" style="width: 600px; height: 500px; align: center;">
			<form id="login_form" name="login_form" method="post" class="form-2"
				...
				<p>
					<label for="password"><i class="icon-lock"></i>Contrase̱a</label>
